...
<div class="container-fluid px-4">
                        <h1 class="mt-4 text-center main-title">Add-ons Membership Plan</h1>                         

                        <div class="col-md-12">                             
                               <a href="{{route('admin.addons')}}"> <button class="btn btn-outline-success addcatbtn" title="Addons"><i class="fa fa-plus"></i></button></a>
                            </div>
                    <div class="card mb-4">
