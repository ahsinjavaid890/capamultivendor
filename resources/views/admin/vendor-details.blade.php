                                ...
                                <input type="hidden" value="{{$vendors->id}}" id="id">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="email" value="{{$vendors->email}}" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="text" value="{{$vendors->emirates_id}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-input mb-20px">
                                                ...
                                                <input type="text" placeholder="saving" value="{{$vendors->account_title}}" />
                                            </div>
                                            </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                            <div class="info-input mb-20px">
                                                ...
                                                <input type="text" value="{{$vendors->account_no}}"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 cmp_name">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="text" value="{{$vendors->company_name}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 cmp_add">
                                        <div class="info-input mb-20px">
                                            <label>Company Address </label>
                                            <input type="text" value="{{$vendors->company_address}}"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">                                   
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="text" placeholder="" value="{{$vendors->contact_address}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="text" placeholder=""  value="{{$vendors->mobile }}">
								...
								<div class="row">                                   
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="text" placeholder="" value="{{$vendors->zipcode }}">
                                ...
                                <div class="row"> 
                                    @if($vendors->registered_as=="Licensed")                                  
                                        ...
                                        <div class="info-input upload">
                                          ...
                                          <label class="control-label mb-2">Upload Company Logo <span class="link-danger">*</span></label>
                                         <input type="text" class="filestyle" placeholder="IMG-1.png" value="{{$vendors->company_logo}}"> 
                                         <button class="btn">View</button>
                                        </div>
                                   		</div>
                                        <div class="col-md-4 cmp_logo">
                                        ...
                                        <img src="{{asset('uploads/'.$vendors->trade_license_img)}}" style="width:50px;"/>
                                         ...
                                         <input type="text" class="filestyle" placeholder="IMG-1.png" value="{{$vendors->trade_license_img}}"> 
                                         <button class="btn">View</button>
                                        </div>
                                        </div>
                                    	<div class="col-md-4 cmp_logo">
                                        ...
                                        <img src="{{asset('uploads/'.$vendors->passport_img)}}" style="width:50px;"/>
                                         ...
                                         <input type="text" class="filestyle" placeholder="IMG-1.png" value="{{$vendors->passport_img}}"> 
                                         <button class="btn">View</button>
                                        </div>
                                        </div>
                                        ...
                                        <img src="{{asset('uploads/'.$vendors->emirates_id_img)}}" style="width:100px;"/>
                                         ...
                                         <input type="text" class="filestyle" placeholder="IMG-1.png" value="{{$vendors->emirates_id_img}}"> 
                                         <button class="btn">View</button>
                                        </div>
                                        </div>
                                        @endif
