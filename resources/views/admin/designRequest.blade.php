                        ...
                        <div class="row">
                                 ...
                                 <table class="table table-condensed table-striped" id="datatablesSimple">
                                    ...
                                    <tr >                                        
                                        ...
                                        <td class="text-center">
                                        @if($requests->status==1 && $requests->byadmin!=Auth::guard('admin')->user()->id)
                                            <div class="prod-btn"><a href="{{route('admin.viewRequestDetails',[encrypt($requests->id)])}}"><button class=" btn " >View Details</button></a><button class="btn sbmtproposal" data-bs-toggle="modal" data-bs-target="#viewDetails" data="{{$requests->id}}" >Submit Proposal</button></div>
                                        <a href="{{route('admin.rejectRequest',[encrypt($requests->id)])}}"><button class="btn btn-warning">Reject</button></a>
                                        <a href="{{route('admin.acceptRequest',[encrypt($requests->id),encrypt($requests->product_name),encrypt($requests->email)])}}"><button class="btn btn-success">Query</button></a>
                                        @elseif($requests->status==2 && $requests->byadmin==Auth::guard('admin')->user()->id)
                                        ...
                                        @endif
                                       <a href="{{route('admin.deleteRequest',[encrypt($requests->id)])}}"> <button class="btn btn-danger">Delete</button></a>
                                    </td>
                                    </tr>
                                    @endforeach
