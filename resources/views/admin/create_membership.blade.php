...
<main>
    <div class="container-fluid px-4">
         <h1 class="mt-4 text-center main-title">Create Membership Plan</h1> 
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            ...
                                            <input type="text" class="Addmembership" placeholder="Write plan title here" id="plan_title" name="plan_title" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                            <label>Amount <span class="link-danger">*</span></label>
                                            <input type="text" class="Addmembership" placeholder="Write plan amount here" id="amount" name="amount" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="info-input mb-20px">
                                            <label> No of products<span class="link-danger">*</span></label>
                                            <input type="text" class="Addmembership" placeholder="Write product quantity here" id="no_of_product" name="no_of_product" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-input mb-20px">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="info-input mb-20px">
                                                ...
                                                <textarea type="text" class="Addmembership" placeholder="plan details" id="plan_details" name="plan_details" ></textarea>
                                            </div>
                                        </div>
