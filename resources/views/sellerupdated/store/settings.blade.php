            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            Store Settings
                            <div class="text-muted pt-2 font-size-sm">Manage Store Settings</div>
                        </h3>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <form class="" action="{{ route('seller.updatestoresettings') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control mb-3" placeholder="Shop Name" name="shop_name" value="{{$store->company_name}}" required="" />
                                    </div>
                                </div>
                                <div class="row mb-3">
