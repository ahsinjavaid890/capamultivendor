        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg" style="width: 400px;">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-8 pl-9 pb-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{asset('sellernew/media/misc/bg-1.jpg')}});">
                            <!--begin::Title-->
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                        <div class="d-flex flex-column text-right pr-3">
                            <span class="text-muted font-weight-bold font-size-base d-none d-md-inline">{{ Auth::guard('seller')->user()->fname }} {{ Auth::guard('seller')->user()->lname }}</span>
                            <span class="text-dark-75 font-weight-bolder font-size-base d-none d-md-inline">{{ Auth::guard('seller')->user()->shop_name }}</span>
                        </div>
                        <!-- High Priority -->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    <div class="navi navi-spacer-x-0 pt-5">
                        ...
                        <div class="navi-footer  px-8 py-5">
                            <a href="{{ route('seller.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"  role="button"  class="btn btn-light-primary font-weight-bold">Sign Out</a>
