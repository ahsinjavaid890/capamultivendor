        ...
        if (input.files) {
            ...
            for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function(event) {
                    $("div.previe_multiple_image").append('<div class="col-md-4 prev_mul_img"> <div class="uploaded-img"> <img class="img-thumbnail" style="width:100%;" src="'+event.target.result+'"/> <div class="edit-trash d-flex"> <img class="white remove_prod_mul_img" src="{{asset("seller/assets/img/white-trash.svg")}}"/> </div></div></div>').show();
