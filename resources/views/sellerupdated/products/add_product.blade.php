...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
               <div class="col-md-12">
               <h1 class="mt-4 main-title">Add Product</h1>
               </div>
            </div>
                <form action="{{route('seller.addProductProcess')}}" method="POST" enctype="multipart/form-data">
                      @csrf   
                      <div class="row">
                            ...
                            <div class="card user-image">
                               ...
                               <div class="featured-img upload-content">
                                  ...
                                  <div class="uploaded-img">
                                     <img style="width:120px;" class="featured_prev_img img-thumbnail" />
                        ...
                        <div class="col-md-12 mt-5">
                           <div class="card mb-5">
                            ...
                            <div class="card product-attribute">
                               <div class="card-body">
                                     @if(Auth::guard('seller')->user()->delivery_by=='vendor')
                                     <div class="col-md-12">
        ...
        if (input.files) {
            ...
            for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function(event) {
                    $("div.previe_multiple_image").append('<div class="col-md-4 prev_mul_img"> <div class="uploaded-img"> <img class="img-thumbnail" style="width:100%;" src="'+event.target.result+'"/> <div class="edit-trash d-flex"> <img class="white remove_prod_mul_img" src="{{asset("public/seller/assets/img/white-trash.svg")}}"/> </div></div></div>').show();
