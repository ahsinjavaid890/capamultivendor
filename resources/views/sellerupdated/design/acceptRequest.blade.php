...
@section('title','Accept Design Request')
@section('content')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom mt-5">
                ...
                <div class="card-body">
                     <form action="{{route('seller.requestAcceptMail')}}" method="POST" id="reqFrm">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="info-input mb-20px">
                                            <label>Request </label>
                                            <input type="text" value="{{$reqTitle}}" name="reqTitle" class="acceptRequest form-control"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="info-input mb-20px">
