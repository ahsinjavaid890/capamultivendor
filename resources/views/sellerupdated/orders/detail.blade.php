            ...
            <div class="row">
                <div class="col-lg-6">
                    <select onchange="location = this.value;" class="form-control">
                        ...
                        <option value="{{ url('seller/orders/changeorderstatus') }}/{{ $data->id }}/packed" @if($data->status == 'packed') selected @endif>Packed</option>
                        <option value="{{ url('seller/orders/changeorderstatus') }}/{{ $data->id }}/shipped" @if($data->status == 'shipped') selected @endif>Shipped</option>
                        <option value="{{ url('seller/orders/changeorderstatus') }}/{{ $data->id }}/received" @if($data->status == 'received') selected @endif>Received</option>
                        <option value="{{ url('seller/orders/changeorderstatus') }}/{{ $data->id }}/cancled" @if($data->status == 'cancled') selected @endif>Cancled</option>
                    </select>
                </div>
                <div class="col-lg-6 text-right">
                    <a href="{{ url('seller/orders/downloadinvoice') }}/{{ $data->id }}" class="btn btn-block btn-primary mb-2"><i class="mdi mdi-download"></i>Download Invoice</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
