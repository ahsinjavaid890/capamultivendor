    ...
    <div class="row">
        ...
        <div class="col-md-6 register-as">
            <div class="d-flex tabs">
                <a href="/customer-login">Sign in as Customer</a>
                <a href="/seller-login">Sign in as Seller</a>
            </div>
            ...
            <div class="row">
                ...
                @error('email')
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <p class="hv-account">Already have an account? <a href="{{route('website.register')}}">Sign Up</a></p>
                    </div>
