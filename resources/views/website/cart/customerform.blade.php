<!-- <div class="schedule-delivery checkout-radio">
    ...
    <div class="radio-button">
        <div class="input-label"> 
            <input value="free" class="form-control" checked type="radio" name="delivery" id="free"/>
    ...
    <div class="radio-button">
        <div class="input-label">
            <input value="express" class="form-control" type="radio" name="delivery" id="express-delivery"/>
...
<div class="schedule-delivery checkout-radio">
    ...
    <div class="radio-button">
        <div class="input-label">
            <input checked id="stripe" type="radio" name="payment_method" class="payment_mode form-control" value="1">
    ...
    <div class="radio-button">
        <div class="input-label">
            <input id="cod" type="radio" name="payment_method" class="payment_mode form-control" value="2">
