                                                ...
                                                <form method="POST" action="{{ url('continuetopayement') }}">
                                                    ...
                                                    <div class="billing-info-wrap">
                                                        ...
                                                        <div class="checkout-account mb-30px">
                                                            <input class="checkout-toggle2" type="checkbox" id="an-account"/>
                                                                ...
                                                                <div class="schedule-delivery checkout-radio">
                                                                    ...
                                                                    <div class="radio-button">
                                                                        <div class="input-label">
                                                                            <input required type="radio" name="cus_address" value="{{$cust_Address->id}}" id="{{ $cust_Address->id }}"/>
                                                        ...
                                                        <div class="your-order-product-info">
                                                            ...
                                                            <div class="your-order-middle">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <img class="img-thumbnail" src="{{asset('products/'.$r['image'])}}" >
                                                            ...
                                                            <div class="your-order-total">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        AED <span id="totalprice"> {{$total_price}} </span></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="your-order-product-info">
                                                            ...
                                                            <div class="your-order-total">
                                                                <ul>
                                                                    ...
                                                                    <li><div class="small">AED 1029.00</div>AED 1029.00</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
