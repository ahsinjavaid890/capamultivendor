<ul class="nav nav-tabs mb-6 us-nav-class" role="tablist">
    ...
    <img src="{{asset('products/orders.svg')}}" alt="" class="icon-head circle" >
    ...
    <li class="link-item">
        <a href="{{route('website.myaddress')}}" class="nav-link-new">
                         <img src="{{asset('products/address.svg')}}" alt="" class="icon-head circle" >
    ...
    <li class="link-item">
        <a href="{{route('website.cust_designReq')}}" class="nav-link-new">   
             <img src="{{asset('products/wallet.svg')}}" alt="" class="icon-head circle" >
    ...
    <img src="{{asset('products/returns.svg')}}" alt="" class="icon-head circle return" >
    ...
    <li class="link-item">
        <a class="nav-link-new" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="#">
             ...
             <img src="{{asset('products/logout.svg')}}" alt="" class="icon-head circle return" style="width:38px; padding: 2px 10px 1px;"> &nbsp; Logout</a>
            <!-- <img src="{{asset('products/nav-arrow.svg')}}" alt="" class="nav-li-arrow"> -->
