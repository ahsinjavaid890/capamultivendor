    ...
    <div class="container-fluid">
        <div class="archive-header mb-3">
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <h1 class="mb-4">Search Keyword: {{ $search }}</h1>
            ...
            <div class="col-lg-12 order-lg-last col-md-12 order-md-first">
                <div class="shop-bottom-area mt-35">
                    <div id="new-arrivals" class="deal-area">
                            ...
                            @else
                            <div class="col-md-12">
                                <p style="padding-top: 60px;border: 1px solid #64317b; text-align: center; padding-bottom: 60px; background: #64317b;color: #fff;font-size: 22px;">No products are found !!</p>
                            </div>
                            @endif
                    </div>
                </div>
