                        ...
                        <li><a href="{{route('website.trackorder')}}"><img
                                ...
                                <li>
                                    ...
                                    <div class="reg-sign-btn">
                                        <div class="register">
                                            <span>
                                                <a href="{{route('website.logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                            </span>
                                    ...
                                    @else
                                    <div class="reg-sign-btn">
                                        <div class="" id="hedrSgnup">
                                            <span>
                                                <a href="{{route('website.register')}}">Register</a> | <a
                                                    href="{{route('website.login')}}">Sign in</a>
                                            </span>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="logo">
                        <a href="{{route('website.index')}}"><img class="img-responsive"
                                src="{{asset('public/website/assets/images/logo.png')}}" alt="logo.jpg" /></a>
                    </div>
                </div>
                <div class="col-md-5">
                ...
                <div class="col-md-5 align-self-center">
                    <div class="header-right-element d-flex">
                        ...
                        <!--Cart info Start -->
                        <div class="header-tools d-flex mx-3">
