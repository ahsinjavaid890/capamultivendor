...
@section('content')
<section id="contant-banner" class="text-center ptb-60px" style="background:#edfafc">
    <div class="container">
        <div class="row">
            <h1>Contact Us</h1>
        </div>
...
<section id="contact-detail" class="ptb-60px text-center">
    <div class="container">
        <h1 class="cart-page-title">Contact Information</h1>
        <p class="head-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud</p>
        <div class="row">
...
<section id="contact-form" class="pb-60px">
    <div class="container">
        <div class="row">
                                ...
                                <div class="tab-content jump">
                                    ...
                                    <div id="payments" class="tab-pane">
                                        ...
                                        <div class="accordion" id="accordionExample3">
                                            ...
                                            <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Can a bill carry forward a past due amount from the previous bill?</button>
                                            </h2>
                 ...
                 <div class="billing-info-wrap">
                    <div class="row">
                        ...
                        <div class="register-yourself checkout-radio">
                            ...
                            <input type="radio" name="delivery" id="L-seller">
                            <label for="L-seller">By Phone</label>
                            </div>
                            </div>
                                <div class="radio-button">
                            <div class="input-label">
                            <input type="radio" name="delivery" id="F-seller">
