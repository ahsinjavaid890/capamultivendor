            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img src="{{asset('admin/assets/media/custom/sun.svg')}}">
                    </div>
                </div>
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">
                        <span class="svg-icon svg-icon-xl svg-icon-primary">
                            <img src="{{asset('admin/assets/media/custom/notification-bell.svg')}}">
                        </span>
                    </div>
                </div>
                <!--end::Toggle-->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg" style="width: 400px;">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-8 pl-9 pb-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{asset('admin/assets/media/misc/bg-1.jpg')}});">
                            <!--begin::Title-->
                        ...
                        <div class="p-6">
                            ...
                            <div class="scroll pr-7 mr-n7 ps ps--active-y" data-scroll="true" data-height="300" data-mobile-height="200" style="height: 300px; overflow: hidden;">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-secondary mr-5">
                                        <span class="symbol-label">
                                            <img src="{{asset('admin/assets/media/custom/billing-drop.svg')}}">
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Text-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-secondary mr-5">
                                        <span class="symbol-label">
                                            <img src="{{asset('admin/assets/media/custom/integration-drop.svg')}}">
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Text-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-secondary mr-5">
                                        <span class="symbol-label">
                                            <img src="{{asset('admin/assets/media/custom/message-drop.svg')}}">
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Text-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="symbol symbol-40 symbol-light-secondary mr-5">
                                        <span class="symbol-label">
                                            <img src="{{asset('admin/assets/media/custom/project-drop.svg')}}">
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Text-->
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                        <div class="d-flex flex-column text-right pr-3">
                            ...
                            <span class="text-dark-75 font-weight-bolder font-size-base d-none d-md-inline">Admin</span>
                        </div>
