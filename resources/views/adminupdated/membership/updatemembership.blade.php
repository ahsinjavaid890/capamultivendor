...
@section('title','Update Membership Plane')
@section('content')
                    ...
                    <div class="card-header flex-wrap py-5 d-flex justify-content-between">
                        <div class="card-title">
                            <h3 class="card-label">
                                ...
                                <div class="text-muted pt-2 font-size-sm">Update Membership Plan</div>
                            </h3>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="info-input mb-20px">
                                        ...
                                        <select type="text" class="Addmembership form-control"  id="plan_type" name="plan_type" >
                                ...
                                <div class="col-md-6">
                                    <div class="info-input mb-20px">
                                        ...
                                        <input type="text" class="Addmembership form-control" placeholder="Write plan title here" id="plan_title" name="plan_title" value="{{$membership->title}}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-input mb-20px">
                                        <label>Amount <span class="link-danger">*</span></label>
                                        <input type="text" class="Addmembership form-control" placeholder="Write plan amount here" id="amount" name="amount" value="{{$membership->amount}}"/>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="info-input mb-20px">
                                        <label> No of products<span class="link-danger">*</span></label>
                                        <input type="text" class="Addmembership form-control" placeholder="Write product quantity here" id="no_of_product" name="no_of_product" value="{{$membership->noproducts}}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-input mb-20px">
                                        <label>Online Directory<span class="link-danger">*</span></label>
                                        <select type="text" class="Addmembership form-control"  id="onlinedirectory" name="onlinedirectory" >
                                ...
                                <div class="col-md-6">
                                    <div class="info-input mb-20px">
                                        ...
                                        <select type="text" class="Addmembership form-control"  id="marketplace" name="marketplace" >
                                    ...
                                    <div class="col-md-12">
                                        <div class="info-input mb-20px">
                                            ...
                                            <textarea type="text" class="Addmembership summernote form-control" placeholder="plan details" id="plan_details" name="plan_details" >{!! $membership->description !!}</textarea>
                                        </div>
                                    </div>
