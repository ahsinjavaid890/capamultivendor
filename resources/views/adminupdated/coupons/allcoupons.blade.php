            ...
            <div class="card mb-4">
                <div class="card-header flex-wrap py-5 d-flex justify-content-between">
                    ...
                    <div class="card-btn text-end">
                        <a href="{{route('admin.addcoupons')}}"><button class="btn btn-outline-primary" style="float:right">Add Coupon</button></a>  
                    </div>
                </div>
                <div class="card-body">
                    <div class="assign-coupon">
                        <button class="btn btn-outline-success assign mb-3">Assign Coupon</button>
                        <a href="{{route('admin.assignedcouponvendor')}}"><button class="btn btn-outline-dark  mb-3">Check Assigned Coupon</button></a>
                        <select class="select_vendor form-control  mb-3" name="vendor[]" id="vendor">
