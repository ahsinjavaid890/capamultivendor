        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
               ...
               <h1 class="mt-4 main-title">Edit Product</h1>
                ...
                <form action="{{route('admin.updateProductProcess')}}" method="POST" enctype="multipart/form-data">
                      @csrf   
        ...
        if (input.files) {
            ...
            for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function(event) {
                    $("div.previe_multiple_image").append('<div class="col-md-3 prev_mul_img"> <div class="uploaded-img"> <img style="width:120px;height:120px;" class="img-thumbnail" src="'+event.target.result+'"/> <div class="edit-trash d-flex"> <i class="fa fa-times-circle white remove_prod_mul_img"></i> </div> </div> </div>').show();
