...
<div class="container-fluid px-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('seller.Addvarient')}}" method="POST" id="varientfrm">
                                @csrf
                    ...
                    <div class="card mb-4">
                                        ...
                                        <tbody id="catlist">
                                          ...
                                          @foreach($cat as $category)
                                            <tr>
                                                ...
                                                <td>
                                                @if($category->status==1)
                                                <a href="{{route('seller.varientActive',[encrypt($category->id)])}}"><button class="btn btn-outline-warning activate" title="Block" data="{{$category->id}}" ><i class="fa fa-ban"></i></button></a>
                                                @elseif($category->status==2)
                                                <a href="{{route('seller.varientdeactive',[encrypt($category->id)])}}"><button class="btn btn-outline-success deactivate" title="approved" data="{{$category->id}}"  ><i class="fa fa-check"></i></button></a>
                                                @endif
                                               
                                                <a href="{{route('seller.varientDelete',[encrypt($category->id)])}}"><button class="btn btn-outline-danger delete" title="Delete" data="{{$category->id}}" ><i class="fa fa-trash"></i></button></a>
                            ...
                            <form action="{{route('seller.AddattributeProcess')}}" method="POST" id="attributefrm">
                                @csrf
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                          ...
                                          @foreach($attribute as $sizes)
                                            <tr>
                                                ...
                                                @if($sizes->status==1)
                                                   ...
                                                   <a href="{{route('seller.AttributeActive',[encrypt($sizes->id)])}}"><button class="btn btn-outline-warning sizeactivate" title="Block" data="{{$sizes->id}}" ><i class="fa fa-ban"></i></button></a>
                                               
                                                @elseif($sizes->status==2)
                                                
                                                   
                                                <a href="{{route('seller.Attributedeactive',[encrypt($sizes->id)])}}"> <button class="btn btn-outline-success sizedeactivate" title="approved" data="{{$sizes->id}}"  ><i class="fa fa-check"></i></button></a>
                                               
                                                @endif                                               
                                                
                                                <a href="{{route('seller.AttributeDelete',[encrypt($sizes->id)])}}"> <button class="btn btn-outline-danger sizedelete" title="Delete" data="{{$sizes->id}}" ><i class="fa fa-trash"></i></button></a>
