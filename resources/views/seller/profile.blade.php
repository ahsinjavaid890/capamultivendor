...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="form-detail personal-info">
                <div class="row">
                    ...
                    <div class="products-delivery checkout-radio">
                        <h4 class="mb-25 font_20"><strong>Products Delivery Via</strong></h4>
                        <div class="both-radio">
                            <div class="radio-button">
                            <div class="input-label me-5">
       ...
       <div class="row mt-5 contact-information">
           <div class="col-md-12">
               <div class="card bg-white shadow-sm">
                   <div class="card-body">
                       <div class="tabs-main-block">
                              ...
                              @if($choosen_plan)
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 plans_details">                                               
                                            <h3 class="pricing-card-title">{{$choosen_plan->title}} <sub class="monthly">{{$choosen_plan->amount}} AED/monthly</sub></h3>
