     ...
     $(function(){
        $("button.activate").click(function(e){
            ...
            if(!confirm("Are you sure want to change this status")){
                ...
                form.append('id',id);
                $.ajax({
                    url:"{{route('seller.categoryActive')}}",
                    type:"POST",
                    data:form,
                    cache:false,
                    contentType:false,
        ...
        $("button.deactivate").click(function(e){
            ...
            if(!confirm("Are you sure want to change this status")){
                ...
                form.append('id',id);
                $.ajax({
                    url:"{{route('seller.categorydeactive')}}",
                    type:"POST",
                    data:form,
                    cache:false,
                    contentType:false,
        ...
        $("button.delete").click(function(e){
            ...
            if(!confirm("Are you sure want to delete this")){
                ...
                form.append('id',id);
                $.ajax({
                    url:"{{route('seller.categoryDelete')}}",
                    type:"POST",
                    data:form,
                    cache:false,
                    contentType:false,
         ...
         $("button.updatecatprocess").click(function(e){
             ...
             $("input.catname").each(function(){
                    ...
                    if(isValid != true){
                        ...
                        form.append('caticon',caticon[0]);
                        $.ajax({
                            url:"{{route('seller.categoryupdate')}}",
                            type:"POST",
                            data:form,
                            cache:false,
                            contentType:false,
