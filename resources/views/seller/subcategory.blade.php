     ...
     $(function(){
        $("button.activate").click(function(e){
            ...
            if(!confirm("Are you sure want to change this status")){
                ...
                form.append('id',id);
                $.ajax({
                    url:"{{route('seller.subcategoryActive')}}",
                    type:"POST",
                    data:form,
                    cache:false,
                    contentType:false,
        ...
        $("button.deactivate").click(function(e){
            ...
            if(!confirm("Are you sure want to change this status")){
                ...
                form.append('id',id);
                $.ajax({
                    url:"{{route('seller.subcategoryDeactive')}}",
                    type:"POST",
                    data:form,
                    cache:false,
                    contentType:false,
        ...
        $("button.delete").click(function(e){
            ...
            if(!confirm("Are you sure want to delete this")){
                ...
                form.append('id',id);
                $.ajax({
                    url:"{{route('seller.subcategoryDelete')}}",
                    type:"POST",
                    data:form,
                    cache:false,
                    contentType:false,
             ...
             $("input.subcatname").each(function(){
                ...
                $("select.selectcat").each(function(){
                    ...
                    if(isValid != true){
                        ...
                        $.ajax({
                            url:"{{route('seller.addsubCategory')}}",
                            type:"POST",
                            data:form,
                            cache:false,
                            contentType:false,
             ...
             $("input.subcatname").each(function(){
                ...
                $("select.selectcat").each(function(){
                    ...
                    if(isValid != true){
                        ...
                        $.ajax({
                            url:"{{route('seller.subcategoryupdate')}}",
                            type:"POST",
                            data:form,
                            cache:false,
                            contentType:false,
